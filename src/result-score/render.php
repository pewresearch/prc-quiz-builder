...
if ( ! $bypass_scoring ) {
	...
	$submission_data    = array_key_exists( 'prc-quiz/results/submissionData', $block->context ) ? $block->context['prc-quiz/results/submissionData'] : array();
