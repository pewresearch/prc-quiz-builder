<!-- wp:prc-block/dialog {"dialogId":"create-group-from-results","className":"is-style-standard"} -->
<!-- wp:prc-block/dialog-trigger -->
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Create a Group</a></div>
<!-- /wp:button -->
<!-- /wp:prc-block/dialog-trigger -->
...
<p style="line-height:1"><strong>Share this quiz with friends, family, or your class. Create a group for:</strong></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:prc-block/form {"namespace":"prc-quiz/controller","action":"createGroupFromResults","layout":{"type":"constrained","orientation":"vertical","verticalAlignment":"center","allowOrientation":true,"contentSize":"420px","justifyContent":"left"},"interactiveNamespace":"prc-quiz/controller"} -->
...
<div class="wp-block-prc-block-form-input-text"><label>Group Name</label><input placeholder="Enter your group name" name="groupName" type="text" required class=""/></div>
<!-- /wp:prc-block/form-input-text -->

<!-- wp:prc-block/form-submit -->
<!-- wp:button {"tagName":"button","type":"submit"} -->
<div class="wp-block-button"><button type="submit" class="wp-block-button__link wp-element-button">Create Group</button></div>
<!-- /wp:button -->
