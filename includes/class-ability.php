	...
	public function register_ability(): void {
		...
		wp_register_ability(
			...
			array(
				...
				'meta'                => array(
					'annotations'  => array(
						'instructions' => 'Pass a quiz post_id to retrieve submission counts (_report) and community group analytics. Use vip/content-search with subtype=quiz to find quiz IDs first. Requires edit access to the quiz. If Firebase is down, submissions still return and groups includes an error field.',
						'readonly'     => true,
						'destructive'  => false,
						'idempotent'   => true,
					),
